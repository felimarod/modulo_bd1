...
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E003','Actualización requerida','Por favor, actualiza la información del reporte.','Bor',TO_DATE('02/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('10:30:00','HH24:MI:SS'),'GioUs','SOC');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E004','Confirmación de reunión','Te confirmo mi asistencia a la reunión del viernes.','Env',TO_DATE('03/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('14:00:00','HH24:MI:SS'),'GioUs','NOT');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E005','Tarea finalizada','He terminado la tarea asignada, ¿podrías revisarla?','Rec',TO_DATE('28/02/2025','DD/MM/YYYY'),TO_TIMESTAMP('15:45:00','HH24:MI:SS'),'Alejo','PRI');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E006','Solicitud de comentarios','Por favor, comparte tus comentarios sobre el proyecto.','Env',TO_DATE('01/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('16:20:00','HH24:MI:SS'),'Alejo','PRO');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E007','Reunión de seguimiento','Necesitamos coordinar una reunión para evaluar avances.','Bor',TO_DATE('02/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('11:50:00','HH24:MI:SS'),'Alejo','SOC');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E008','Documentación necesaria','Faltan algunos documentos para el cierre del proyecto.','Env',TO_DATE('03/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('18:30:00','HH24:MI:SS'),'Alejo','NOT');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E009','Nueva propuesta','He subido una propuesta nueva para el diseño.','Rec',TO_DATE('28/02/2025','DD/MM/YYYY'),TO_TIMESTAMP('08:00:00','HH24:MI:SS'),'FeliM','PRI');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E010','Estado del presupuesto','¿Podrías confirmar el estado del presupuesto actual?','Env',TO_DATE('01/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('09:45:00','HH24:MI:SS'),'FeliM','PRO');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E011','Planificación del sprint','Adjunto la planificación para el próximo sprint.','Bor',TO_DATE('02/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('13:10:00','HH24:MI:SS'),'FeliM','SOC');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E012','Entrega pendiente','La entrega del cliente está programada para mañana.','Env',TO_DATE('03/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('17:00:00','HH24:MI:SS'),'FeliM','NOT');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E013','Revisión de código','Por favor, revisa los cambios en el repositorio.','Rec',TO_DATE('28/02/2025','DD/MM/YYYY'),TO_TIMESTAMP('10:15:00','HH24:MI:SS'),'MCarv','PRI');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E014','Problema técnico','Se ha reportado un problema técnico en el sistema.','Env',TO_DATE('01/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('14:05:00','HH24:MI:SS'),'MCarv','PRO');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E015','Solicitud de reunión','Coordina una reunión con el cliente para resolver dudas.','Bor',TO_DATE('02/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('15:30:00','HH24:MI:SS'),'MCarv','SOC');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E016','Confirmación de entrega','El cliente confirmó la recepción del producto final.','Env',TO_DATE('03/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('18:20:00','HH24:MI:SS'),'MCarv','NOT');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E017','Cambio en especificaciones','El cliente ha solicitado cambios en las especificaciones.','Rec',TO_DATE('28/02/2025','DD/MM/YYYY'),TO_TIMESTAMP('11:00:00','HH24:MI:SS'),'JLope','PRI');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E018','Entrega de borrador','Adjunto el borrador del proyecto para tu revisión.','Env',TO_DATE('01/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('13:00:00','HH24:MI:SS'),'JLope','PRO');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E019','Seguimiento del proyecto','Por favor, envía un reporte del avance del proyecto.','Bor',TO_DATE('02/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('15:10:00','HH24:MI:SS'),'JLope','SOC');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E020','Confirmación de cambios','Confirma si los cambios solicitados han sido implementados.','Env',TO_DATE('03/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('17:50:00','HH24:MI:SS'),'JLope','NOT');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E021','Soporte técnico','Necesito ayuda con un problema técnico urgente.','Rec',TO_DATE('28/02/2025','DD/MM/YYYY'),TO_TIMESTAMP('09:30:00','HH24:MI:SS'),'DMarc','PRI');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E022','Actualización del sistema','Se requiere una actualización del sistema operativo.','Env',TO_DATE('01/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('12:15:00','HH24:MI:SS'),'DMarc','PRO');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E023','Documentación adicional','Por favor, proporciona más documentación técnica.','Bor',TO_DATE('02/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('14:20:00','HH24:MI:SS'),'DMarc','SOC');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E024','Tareas pendientes','Envía un listado de las tareas pendientes.','Env',TO_DATE('03/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('16:40:00','HH24:MI:SS'),'DMarc','NOT');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E025','Aprobación de propuesta','La propuesta enviada está pendiente de aprobación.','Rec',TO_DATE('28/02/2025','DD/MM/YYYY'),TO_TIMESTAMP('08:45:00','HH24:MI:SS'),'CAndr','PRI');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E026','Revisión de contratos','Por favor, revisa los contratos adjuntos.','Env',TO_DATE('01/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('11:10:00','HH24:MI:SS'),'CAndr','PRO');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E027','Coordinación de equipo','Organiza una reunión para coordinar al equipo.','Bor',TO_DATE('02/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('13:40:00','HH24:MI:SS'),'CAndr','SOC');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E028','Reporte de errores','Adjunto un listado de errores encontrados.','Env',TO_DATE('03/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('16:00:00','HH24:MI:SS'),'CAndr','NOT');
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E029','Progreso de tareas','Por favor, envía un informe del progreso actual.','Rec',TO_DATE('28/02/2025','DD/MM/YYYY'),TO_TIMESTAMP('10:00:00','HH24:MI:SS'),'VQuin','PRI');
...
INSERT INTO mensaje (idmensaje,asunto,cuerpomensaje,idtipocarpeta,fechaaccion,horaaccion,usuario,idcategoria) VALUES ('E040','Notificación de cambios','Se han realizado cambios en el alcance del proyecto.','Env',TO_DATE('03/03/2025','DD/MM/YYYY'),TO_TIMESTAMP('18:00:00','HH24:MI:SS'),'RSali','NOT');
